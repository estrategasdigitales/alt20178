...
class WordPress_GDPR_Integrations extends WordPress_GDPR
{
    ...
    public function add_privacy_policy_checkbox_to_comment_form($submit_field, $args)
    {
    ...
    public function add_privacy_policy_checkbox_to_buddypress_registration()
    {
        ...
        <p class="gdpr-buddypress-checkbox-container">
            <label class="buddypress-form__label buddypress-form__label-for-checkbox checkbox">
                <input type="checkbox" class="buddypress-form__input buddypress-form__input-checkbox input-checkbox" name="privacy_policy" id="privacy_policy" required> <a href="' . $link . '" target="_blank" class="buddypress-privacy-policy-link"><span>'
                . $text . ' </a></span> <span class="required">*</span>
            </label>
        </p>';
