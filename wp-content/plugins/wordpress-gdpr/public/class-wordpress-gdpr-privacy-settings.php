...
class WordPress_GDPR_Privacy_Settings extends WordPress_GDPR
{
    ...
    public function add_trigger()
    {
        ...
        <a href="#" class="wordpress-gdpr-privacy-settings-trigger-container wordpress-gdpr-open-privacy-settings-modal <?php echo $position ?>"
    ...
    {
        $popupEnable = $this->get_option('privacySettingsPopupEnable');
        if(!$popupEnable) {
            return false;
        }
        ...
        if(isset($privacySettingsPopupLogo['url']) && !empty($privacySettingsPopupLogo['url'])) {
            $logo = '<img src="' . $privacySettingsPopupLogo['url'] . '">';
        ...
        foreach ($service_categories as $service_category) {
            ...
            foreach ($services as $service) {
                ...
                $service_html .= '<div class="wordpress-gdpr-popup-privacy-settings-services-content-title-box">';
                    $service_html .= '<a href="#" data-id="' . $service->ID . '" class="wordpress-gdpr-popup-privacy-settings-services-content-title"><i class="fa fa-caret-right"></i> ' . $service->post_title . '</a>';
        ...
        <div class="wordpress-gdpr-privacy-settings-popup-container">
            <div class="wordpress-gdpr-privacy-settings-popup" 
                ...
                <a href="#" id="wordpress-gdpr-privacy-settings-popup-close" class="wordpress-gdpr-privacy-settings-popup-close" style="background-color: <?php echo $privacySettingsPopupCloseIconBackgroundColor ?>;">
                ...
                <div class="wordpress-gdpr-privacy-settings-popup-services-container">
                    <div class="wordpress-gdpr-privacy-settings-popup-service-categories">
                        ...
                        if(!empty($privacySettingsPopupTextPrivacyCenter) && !empty($privacyCenterPage)) {
                            echo '<a target="_blank" href="' . get_permalink($privacyCenterPage) . '" class="wordpress-gdpr-popup-privacy-settings-service-category">' . $privacySettingsPopupTextPrivacyCenter . ' <i class="fa fa-external-link"></i></a>';
                        }
                        ...
                        if(!empty($privacySettingsPopupTextPrivacyPolicy) && !empty($privacyPolicyPage)) {
                            echo '<a target="_blank" href="' . get_permalink($privacyPolicyPage) . '" class="wordpress-gdpr-popup-privacy-settings-service-category">' . $privacySettingsPopupTextPrivacyPolicy . ' <i class="fa fa-external-link"></i></a>';
                        }
                        ...
                        if(!empty($privacySettingsPopupTextCookiePolicy) && !empty($cookiePolicyPage)) {
                            echo '<a target="_blank" href="' . get_permalink($cookiePolicyPage) . '" class="wordpress-gdpr-popup-privacy-settings-service-category">' . $privacySettingsPopupTextCookiePolicy . ' <i class="fa fa-external-link"></i></a>';
                        }
                        ?>
                    </div>
