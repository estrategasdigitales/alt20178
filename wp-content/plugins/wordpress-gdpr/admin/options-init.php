    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type'     => 'checkbox',
                'title'    => __('Enable the Privacy Settings Modal', 'wordpress-gdpr'),
                'default'  => '1',
            ),
            array(
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'     => array(
           array(
                ...
                'desc' => __('If you use WP 4.9.6 this is no longer needed.', 'wordpress-gdpr'),
            ),
            array(
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type'     => 'checkbox',
                'title'    => __('Enable Flamingo DB', 'wordpress-gdpr'),
                'subtitle' => __('This will depending on the opt-in checkbox setting save data or not.', 'wordpress-gdpr'),
                'default'  => '0',
            ),
            array(
            ...
            array(
                ...
                'subtitle' => __('This will add Gravity Forms entries to data export. Checkbox needs to be added to each form manually.', 'wordpress-gdpr'),
                'default'  => '0',
            ),
            array(
