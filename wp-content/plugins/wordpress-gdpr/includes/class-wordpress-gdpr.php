...
class WordPress_GDPR
{
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('init', $this->plugin_admin, 'init', 10);
        ...
        $this->loader->add_action('init', $this->requests, 'init');
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_action('init', $this->cookie_popup, 'init');
        ...
        $this->loader->add_action('init', $this->cookie_service_management, 'init');
        ...
        $this->loader->add_action('init', $this->privacy_settings, 'init');
        $this->loader->add_action('wp_footer', $this->privacy_settings, 'add_popup', 10);
        $this->loader->add_action('wp_footer', $this->privacy_settings, 'add_trigger', 10);
        add_shortcode( 'wordpress_gdpr_privacy_settings', array($this->privacy_settings, 'get_privacy_settings_page'));
        ...
        $this->loader->add_action('init', $this->forms, 'init');
        ...
        // Comments
        $this->loader->add_filter( 'comment_form_submit_field', $this->integrations, 'add_privacy_policy_checkbox_to_comment_form', 10, 2);
        ...
        // $this->loader->add_filter( 'quform_session_cookie_lifetime', $this->integrations, 'maybe_disallow_quform_cookie', 50);
