...
function gg_gallery_builder() {
	...
	jQuery(document).delegate('#gg_sort_mode', 'mousedown', function(){
	...
	//// track button click
	jQuery(document).delegate('#gg_select_all_img', 'mousedown', function() {
	...
	jQuery(document).delegate('#gg_wp_cat, #gg_cpt_tax_term, #gg_album, #gg_picasa_album, #gg_gdrive_album, #gg_fb_album, #gg_ngg_gallery', 'change', function() {
