...
<div class="wrap lcwp_form">  
	...
	if(isset($_POST['lcwp_admin_submit'])) { 
		...
		$indexes[] = array('index'=>'gg_filters_all_txt', 'label'=>__('"All" filter - custom text', 'gg_ml'), 'required'=>true);
		...
		$indexes[] = array('index'=>'gg_preload_hires_img', 'label'=>'Preload hi-resolution images');
		...
		$fdata['gg_filters_all_txt'] = get_option('gg_filters_all_txt', 'All'); 
		...
		$fdata['gg_preload_hires_img'] = get_option('gg_preload_hires_img');
    ...
    <div id="main_opt"> 
        ...
        <table class="widefat lcwp_table">
          ...
          <tr>
            <td class="lcwp_label_td"><?php _e('"All" filter - custom text', 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
            	<input type="text" name="gg_filters_all_txt" value="<?php echo esc_attr($fdata['gg_filters_all_txt']) ?>" />
            </td>
            <td></td>
          </tr>
          <tr>
        ...
        <table class="widefat lcwp_table">
          ...
          <tr>
            <td class="lcwp_label_td"><?php _e("Preload full-resolution images?", 'gg_ml'); ?></td>
            <td class="lcwp_field_td">
                <?php ($fdata['gg_preload_hires_img'] == 1) ? $sel = 'checked="checked"' : $sel = ''; ?>
                <input type="checkbox" value="1" name="gg_preload_hires_img" class="ip-checkbox" <?php echo $sel; ?> />
            </td>
            <td>
            	<span class="info"><?php _e("Check to preload full resolution images once galleries are shown. This speeds-up lightbox opening but increases page's weight", 'gg_ml'); ?></span>
            </td>
          </tr>
          <tr>
    ...
    <div id="styling"> 
		...
		<table class="widefat lcwp_table">
          ...
          <tr>
            ...
            <td><span class="info"><?php _e('Filters background color - default status', 'gg_ml') ?> <?php _e('(not for old style)', 'gg_ml') ?> (<?php _e('supports <em>transparent</em>', 'gg_ml') ?>)</span></td>
          </tr>
          <tr>
            ...
            <td><span class="info"><?php _e('Filters border color - default status', 'gg_ml') ?> <?php _e('(not for old style)', 'gg_ml') ?> (<?php _e('supports <em>transparent</em>', 'gg_ml') ?>)</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><span class="info"><?php _e('Filters background color - mouse hover status', 'gg_ml') ?> <?php _e('(not for old style)', 'gg_ml') ?> (<?php _e('supports <em>transparent</em>', 'gg_ml') ?>)</span></td>
          </tr>
          <tr>
            ...
            <td><span class="info"><?php _e('Filters border color - mouse hover status', 'gg_ml') ?> <?php _e('(not for old style)', 'gg_ml') ?> (<?php _e('supports <em>transparent</em>', 'gg_ml') ?>)</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><span class="info"><?php _e('Filters background color - selected status', 'gg_ml') ?> <?php _e('(not for old style)', 'gg_ml') ?> (<?php _e('supports <em>transparent</em>', 'gg_ml') ?>)</span></td>
          </tr> 
          <tr>
            ...
            <td><span class="info"><?php _e('Filters border color - selected status', 'gg_ml') ?> <?php _e('(not for old style)', 'gg_ml') ?> (<?php _e('supports <em>transparent</em>', 'gg_ml') ?>)</span></td>
          </tr>
          <tr>
          ...
          <tr class="lb_opt_simplelb">
            ...
            <td class="lcwp_field_td">
            	<select data-placeholder="<?php _e("Select a style", 'gg_ml'); ?> .." name="gg_simplelb_style" class="lcweb-chosen" autocomplete="off">
                  <option value="light">Light</option>  
                  <option value="dark" <?php if(isset($fdata['gg_simplelb_style']) && $fdata['gg_simplelb_style'] == 'dark') {echo 'selected="selected"';} ?>>Dark</option>
                </select>
            </td>
            <td><span class="info"><?php _e("Select lightbox skin", 'gg_ml'); ?></span></td>
          </tr>
