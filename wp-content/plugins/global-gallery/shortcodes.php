...
function gg_carousel_shortcode( $atts, $content = null ) {
	...
	// build
	$car .= '
	<div id="gg_car_'.$gid.'" rel="'.$gid.'" class="gg_carousel_wrap gg_gallery_wrap gg_car_preload gg_car_'.get_option('gg_car_elem_style', 'light').' '.$has_arrows_class.' '. $nocrop_class .' '.$pause_on_h.' '.$ol_man->txt_vis_class.' '.$ol_man->ol_wrap_class.'" '.$ol_man->img_fx_attr.'>';
