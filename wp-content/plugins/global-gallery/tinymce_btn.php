      ...
      <div id="gg_sc_tabs">
      	...
      	<div id="gg_sc_gall">
            <table class="lcwp_form lcwp_table lcwp_tinymce_table" cellspacing="0">
              ...
              <tr>
                ...
                <td><span class="info"><?php _e('Displays images randomly', 'gg_ml') ?></span></td>
              </tr>
              <tr>
                ...
                <td><span class="info"><?php _e('Applies watermark to images (where available)', 'gg_ml') ?></span></td>
              </tr>
              <tr>
        ...
        <div id="gg_sc_coll">
            <table class="lcwp_form lcwp_table lcwp_tinymce_table" cellspacing="0">
              ...
              <tr>
                ...
                <td><span class="info"><?php _e('Allows galleries filtering by category', 'gg_ml') ?></span></td>
              </tr>
              <tr>
                <td><?php _e('Random Display', 'gg_ml') ?></td>
                <td style="width: 30%;" class="lcwp_form">
        ...
        <div id="gg_sc_slider">
        	<table class="lcwp_form lcwp_table lcwp_tinymce_table" cellspacing="0">
              ...
              <tr>
                <td><?php _e("Slider's Width", 'gg_ml') ?></td>
              ...
              <tr>
                <td><?php _e("Slider's Height", 'gg_ml') ?></td>
                <td class="lcwp_form">
        ...
        <div id="gg_sc_carousel">
        	<table class="lcwp_form lcwp_table lcwp_tinymce_table" cellspacing="0">
              ...
              <tr>
                <td><?php _e('Avoid images crop?', 'gg_ml') ?></td>
                <td style="width: 30%;" class="lcwp_form">
                    <input type="checkbox" name="gg_car_nocrop" value="1" class="gg_popup_ip" id="gg_car_nocrop" />
                </td>
                <td><span class="info"><?php _e('Just downscales images', 'gg_ml') ?></span></td>
              </tr>
              <tr>
                <td><?php _e('Random Display', 'gg_ml') ?></td>
                <td style="width: 30%;" class="lcwp_form">
