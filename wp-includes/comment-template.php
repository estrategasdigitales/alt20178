...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label> <textarea id="comment" class="form-control" name="comment" cols="45" rows="2" maxlength="65525" aria-required="true" required="required"></textarea></p>',
		...
		'submit_button'        => '<input name="%1$s" class="btn vc_btn3-style-flat vc_btn3-color-danger" type="submit" id="%2$s" class="%3$s" value="%4$s" />',
